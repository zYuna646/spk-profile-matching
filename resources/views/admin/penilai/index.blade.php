...
@section('content')
    ...
    <div class="card h-100">
        ...
        <div class="card-header d-flex justify-content-between align-items-center">
            <h5 class="card-title mb-0">Penilai</h5>
            <button onclick="window.location.href='{{ route('penilai.users.create') }}'" type="button"
                ...
                <tbody>
                    @foreach ($data as $item)
                        <tr>
                            ...
                            <td>
                                <!-- Show button -->
                                <button onclick="window.location.href='{{ route('penilai.users.show', $item) }}'"
                                    type="button" class="btn btn-icon btn-outline-info" title="Show">
                                    <span class="tf-icons bx bx-show"></span>
                                </button>
                                <!-- Edit button -->
                                <button onclick="window.location.href='{{ route('penilai.users.edit', $item) }}'"
                                    type="button" class="btn btn-icon btn-outline-warning" title="Edit">
                                    <span class="tf-icons bx bx-edit"></span>
                                </button>
                                <!-- Delete button -->
                                <form action="{{ route('penilai.users.destroy', $item) }}" method="POST"
