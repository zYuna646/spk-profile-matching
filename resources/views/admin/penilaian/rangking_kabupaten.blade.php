...
@section('content')
    ...
    <div class="card h-100">
        ...
        <div class="card-body" style="height: 100%;">
            ...
            <!-- Filter Form -->
            <form action="{{ route('rangking.kabupaten') }}" method="GET" class="mb-3">
            ...
            <div class="mb-3">
                <a href="{{ route('kabupaten.rangking', ['kab_id' => $kabupaten->id ?? 'a', 'periode' => $per->id ?? 'a']) }}"
                    class="btn btn-info">Cetak
                    Laporan
                    Rangking</a>
                <a href="{{ route('kabupaten.status', ['kab_id' => $kabupaten->id ?? 'a', 'periode' => $per->id ?? 'a']) }}"
                    ...
                    @foreach ($rangking as $key => $item)
                        <tr>
                            ...
                            <td>
                                ...
                                @else
                                    <form action="{{ route('kabupaten.terima', $item['peserta']) }}" method="POST"
                                    ...
                                    <form action="{{ route('kabupaten.tolak', $item['peserta']) }}" method="POST"
                                        style="display:inline;">
                                        @csrf
