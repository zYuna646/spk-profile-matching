...
@section('content')
    ...
    <div class="card h-100">
        ...
        <div class="card-header d-flex justify-content-between align-items-center">
            <h5 class="card-title mb-0">Alumni</h5>
            <button onclick="window.location.href='{{ route('alumni.create') }}'" type="button"
        ...
        <div class="card-body" style="height: 100%;">
            ...
            <table id="table_config" class="display" style="width:100%; height: 100%;">
                <thead>
                    <tr>
                        <th>Nama</th>
                        <th>Tahun Menjalankan Program</th>
                        <th>Aksi</th>
                    </tr>
                </thead>
                <tbody>
                    @foreach ($data as $item)
                        <tr>
                            ...
                            <td>
                                <!-- Show button -->
                                <button onclick="window.location.href='{{ route('alumni.show', $item) }}'" type="button"
                                    class="btn btn-icon btn-outline-info" title="Show">
                                    <span class="tf-icons bx bx-show"></span>
                                </button>
                                <!-- Edit button -->
                                <button onclick="window.location.href='{{ route('alumni.edit', $item) }}'" type="button"
